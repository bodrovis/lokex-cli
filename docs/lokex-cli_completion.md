## lokex-cli completion

Generate the autocompletion script for the specified shell

### Synopsis

Generate the autocompletion script for lokex-cli for the specified shell.
...
* [lokex-cli completion bash](lokex-cli_completion_bash.md)	 - Generate the autocompletion script for bash
* [lokex-cli completion fish](lokex-cli_completion_fish.md)	 - Generate the autocompletion script for fish
* [lokex-cli completion powershell](lokex-cli_completion_powershell.md)	 - Generate the autocompletion script for powershell
* [lokex-cli completion zsh](lokex-cli_completion_zsh.md)	 - Generate the autocompletion script for zsh
